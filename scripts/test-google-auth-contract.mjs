...
assert.match(loginSource, /oauth_apple/);
assert.doesNotMatch(loginSource, /<AppleMark/);
assert.doesNotMatch(loginSource, /Continue with Apple/);
...
assert.match(loginSource, /Google and LinkedIn Login only create your Margin account/);
