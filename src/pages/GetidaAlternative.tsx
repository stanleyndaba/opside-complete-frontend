...
const comparisonRows = [
  {
    topic: 'Discrepancy detection',
    getida: 'Public information not verified.',
    margin: 'Margin turns discrepancy signals into recovery events that move into Detect and Classify stages.',
  },
  {
    topic: 'Evidence organization',
    getida: 'Public information not verified.',
    margin: 'Margin organizes supporting records around the case so evidence stays attached to the recovery path.',
  },
  {
  ...
  {
    topic: 'Rejection management',
    getida: 'Public information not verified.',
    margin: 'Margin keeps rejected cases visible so follow-up and dispute paths can be managed after the first response.',
  },
  {
    topic: 'Lowball dispute handling',
    getida: 'Public information not verified.',
    margin: 'Margin keeps low offers in the recovery workflow so evidence and payout variance can be reviewed.',
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'Look for clarity around the full reimbursement workflow, not only discrepancy discovery. Sellers should understand how a platform handles evidence preparation, claim readiness, filing control, rejection follow-up, dispute handling, payout reconciliation, and seller approval before action.',
  },
  {
    question: 'How does Margin differ from reimbursement reporting tools?',
    answer:
      'Margin is designed as a recovery workflow, not only a report of possible discrepancies. The workflow moves through Detect, Classify, Bind Evidence, Approve, and Track Outcome so reimbursement work stays connected from finding to resolution.',
  },
  {
...
const pageMeta = getPublicRouteMeta('/getida-alternative')!;
    ...
    () => ({
      ...
      '@graph': [
        ...
        },
        {
          ...
          name: 'GETIDA alternative reimbursement workflow',
      ...
      <main className="relative">
        ...
        <section className="relative pt-28 md:pt-40">
          <div className={containerClass}>
            ...
            >
              <div className={labelClass}>GETIDA Alternative</div>
              <h1 className="mt-5 max-w-[980px] text-[38px] font-semibold leading-[0.98] tracking-[-0.06em] text-[#182026] sm:text-[46px] md:text-[76px]">
                Looking For A GETIDA Alternative?
              </h1>
              <p className="mt-5 max-w-[820px] text-[16px] leading-7 text-[#4D5B66] md:mt-7 md:text-[19px] md:leading-8">
              ...
              <div className="min-w-[780px]">
                ...
                {comparisonRows.map((row, index) => (
                  ...
                  >
                    ...
                    <div className="text-[14px] leading-7 text-[#66737F] md:text-[15px]">{row.getida}</div>
        ...
        <section className="relative border-t border-[#E4EDF1] py-16 md:py-28">
          <div className={containerClass}>
            <motion.div {...revealProps}>
              ...
              <h2 className={headingClass}>Frequently asked questions about evaluating a GETIDA alternative.</h2>
            </motion.div>
