          ...
          <div className="relative mx-auto max-w-3xl px-6 pt-20 md:pt-28 pb-24 text-gray-600">
            ...
            <section className="mt-10">
              <div className="rounded-2xl border border-gray-200 bg-[#111827] shadow-[0_25px_60px_rgba(15,23,42,0.18)]">
                ...
                <pre className="p-6 overflow-x-auto text-sm md:text-base leading-relaxed text-gray-200" style={{ fontFamily: "'Fira Code', 'JetBrains Mono', 'Source Code Pro', 'Consolas', 'Monaco', 'Menlo', 'Courier New', monospace" }}><code>
