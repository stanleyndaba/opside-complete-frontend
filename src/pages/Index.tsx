      ...
      <div className="relative flex h-full items-center justify-center p-3 sm:p-5">
        <div className="w-full max-w-[390px] space-y-2.5">
          {items.map(({ title, detail, status, tone }) => (
            <div key={title} className="rounded-[10px] border border-white/75 bg-white/62 px-3 py-2.5 shadow-[0_14px_30px_rgba(20,31,34,0.18),inset_0_1px_0_rgba(255,255,255,0.92)] ring-1 ring-white/25 backdrop-blur-xl sm:px-4 sm:py-3">
