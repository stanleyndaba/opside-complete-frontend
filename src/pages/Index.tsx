                    ...
                    >
                      {[...Array(2)].map((_, outerIndex) => (
                        <div key={outerIndex} className="flex flex-none items-center">
                          ...
                          <img src="/onedrivelogo.png" alt="OneDrive_DEPLOY_CHECK_1" className="h-[100px] md:h-[120px] w-auto bg-red-500/20 opacity-80 transition-all duration-700 hover:opacity-100 cursor-default mr-16 md:mr-32 pointer-events-none" />
                          <img src="/adobesign.png" alt="Adobe Sign_DEPLOY_CHECK_1" className="h-[100px] md:h-[120px] w-auto bg-red-500/20 opacity-80 transition-all duration-700 hover:opacity-100 cursor-default mr-16 md:mr-32 pointer-events-none" />
