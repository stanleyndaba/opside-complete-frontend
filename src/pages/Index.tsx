...
function DiscrepancyModalVisual() {
  ...
  return (
    <div className="relative overflow-hidden rounded-[10px] border border-[#DCE8EE] bg-[#596068]/90 p-3 shadow-[0_22px_70px_rgba(24,32,38,0.18)] sm:p-5">
      <div className="mx-auto max-h-[620px] w-full max-w-[760px] overflow-hidden rounded-[10px] border border-[#DCE8EE] bg-white text-[#182026] shadow-[0_18px_45px_rgba(24,32,38,0.16)]">
