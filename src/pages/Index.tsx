...
function DiscrepancyModalVisual({ compactMobile = false }: { compactMobile?: boolean }) {
  ...
  return (
    <div className={`relative overflow-hidden rounded-[10px] border border-[#D9E2E6] bg-[#E9EEEC] p-2 shadow-[0_20px_60px_rgba(72,103,122,0.14)] sm:p-3 ${compactMobile ? "max-h-[440px] sm:max-h-none" : ""}`}>
