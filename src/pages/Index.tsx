      ...
      <div className={containerClass}>
        <div className="grid items-start gap-8 lg:grid-cols-[0.72fr_1.28fr] lg:items-center lg:gap-12">
          <motion.div {...revealProps} className="order-1 border-l border-[#D8DEDA] pl-4 md:pl-5">
            ...
            <p className="mt-4 max-w-[560px] text-[14px] leading-6 text-[var(--margin-text-secondary)] sm:text-[15px] sm:leading-7">You shouldn&apos;t have to search through old Amazon cases, remember which shipment a reply belonged to, or work out whether a reimbursement was actually complete.</p>
            <p className="mt-4 max-w-[560px] text-[14px] leading-6 text-[var(--margin-text-secondary)] sm:text-[15px] sm:leading-7">When you come back to a recovery, you can see what happened, what Amazon said, what&apos;s still outstanding, and what needs to happen next — without starting the investigation all over again.</p>
            <p className="mt-5 max-w-[560px] text-[15px] font-semibold leading-7 tracking-[-0.01em] text-[var(--margin-text-primary)] sm:text-[17px] sm:leading-8">Fewer open loops. Less chasing. A clear next step.</p>
          </motion.div>
