    ...
    >
      ...
      <div className="relative z-10 flex w-full items-center">
        <div className="max-w-[1040px]">
          <motion.p initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, ease: [0.22, 1, 0.36, 1] }} className="max-w-[900px] text-[15px] leading-7 text-[#B7CFDC] sm:text-[18px] sm:leading-8">Margin establishes what happened, identifies what doesn&apos;t reconcile, and handles what needs to be resolved — from the first finding to the final payout.</motion.p>
