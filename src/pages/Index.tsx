                    ...
                    >
                      {[...Array(2)].map((_, outerIndex) => (
                        <div key={outerIndex} className="flex flex-none items-center">
                          ...
                          <img src="/onedrivelogo.png" alt="OneDrive" className="h-[40px] md:h-[52px] w-auto opacity-80 transition-all duration-700 hover:opacity-100 cursor-default mr-16 md:mr-32 pointer-events-none" />
                          <img src="/adobesign.png" alt="Adobe Sign" className="h-[40px] md:h-[52px] w-auto opacity-80 transition-all duration-700 hover:opacity-100 cursor-default mr-16 md:mr-32 pointer-events-none" />
