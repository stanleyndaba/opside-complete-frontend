    ...
    >
      ...
      <div className="relative z-10 flex w-full items-center">
        <div className="max-w-[1040px]">
          ...
          <p className="mt-4 font-lora text-[14px] italic leading-6 tracking-[-0.01em] text-slate-400 sm:mt-5 sm:text-[16px]">You keep selling. Margin handles the recovery work.</p>
