      ...
      <div className="relative">
        ...
        <header className="sticky top-0 z-40 border-transparent bg-transparent">
          ...
          <article className="bg-white/90 border border-black/5 rounded-3xl shadow-[0_25px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl">
            <div className="px-6 py-10 md:px-12 md:py-14 space-y-8 text-gray-700">
              <div dangerouslySetInnerHTML={{
                __html: `
                  ...
                  <li>
                  <p><strong>Application</strong> refers to Clario AI, the software program provided by the Company.</p>
                  </li>
                  <li>
                  <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Clario AI.</p>
                  </li>
                  <li>
                  ...
                  <li>
                  <p><strong>Website</strong> refers to Clario AI, accessible from <a href="https://opside-node-api-woco.onrender.com/" rel="external nofollow noopener" target="_blank">https://opside-node-api-woco.onrender.com/</a></p>
                  </li>
                  <li>
                  ...
                  <ul>
                  <li>By email: clariooai@gmail.com</li>
                  </ul>
                `
              }} />
            </div>
