              ...
              {logs.length > 0 && (
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between text-xs">
                    {/* Left: Last sync time + overall status */}
                    ...
                    {/* Right: Health State dropdown toggle */}
                    <button
                      onClick={() => setHealthExpanded(!healthExpanded)}
                      className="flex items-center gap-1.5 text-gray-600 hover:text-gray-800 transition-colors px-2 py-1 rounded hover:bg-gray-100"
                    >
                  ...
                  {healthExpanded && (
                    <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 animate-in slide-in-from-top-2 duration-200">
