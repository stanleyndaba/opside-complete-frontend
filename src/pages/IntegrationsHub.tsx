        ...
        <div className="relative w-full bg-white min-h-[calc(100vh+96px)] -mt-24 pt-24">
          <div className="relative container mx-auto px-8 pt-8 pb-12 text-gray-900">
            ...
            <div className="mb-8">
              ...
              <p className="text-[10px] text-gray-500 mt-0.5 tracking-[0.15em]">Platform Connections</p>
            </div>
            ...
            <div className="bg-gray-50 border border-gray-200 mb-8">
              <div className="px-6 py-4 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                <div>
                  <p className="text-[9px] font-semibold text-gray-500 tracking-[0.15em]">Manual Upload</p>
                ...
                <button
                  ...
                  className="text-xs font-medium text-gray-900 hover:text-gray-700 transition-colors tracking-[0.1em] border border-gray-300 px-4 py-2 bg-white hover:bg-gray-50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-white border border-gray-200 rounded-sm">
                <div className="px-6 py-4 border-b border-gray-200 bg-gray-50 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-xs font-medium text-gray-900 tracking-[0.15em]">Amazon SP-API</h2>
                      <p className="text-[10px] text-gray-500 mt-0.5">Inventory, orders, fees & returns</p>
                    </div>
                  </div>
                  <span className={cn(
                    'text-[9px] tracking-[0.1em] font-medium',
              ...
              <div className="bg-white border border-gray-200 rounded-sm">
                <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
                  <h2 className="text-xs font-medium text-gray-900 tracking-[0.15em]">Document Sources</h2>
                  <p className="text-[10px] text-gray-500 mt-0.5">Email and cloud for auto-ingestion</p>
                </div>
                <div className="p-6 space-y-4">
                  {evidenceSources.length> 0 && (
                    <div className="mb-4 p-3 bg-gray-50 border border-gray-200">
                      <p className="text-[10px] tracking-[0.1em] text-gray-500 font-medium mb-2">Connected Sources</p>
                  ...
                  <div className="rounded-2xl border border-gray-200 bg-gradient-to-b from-white via-white to-gray-50 p-5 space-y-5">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-center justify-between border-b border-gray-200 pb-3">
                        <div>
                          <p className="text-xs font-semibold text-gray-900 tracking-[0.15em]">Ingestion Filters</p>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                          <label className="block text-[9px] font-semibold text-gray-500 tracking-[0.1em]">Sender Patterns (OR)</label>
                        ...
                        {/* Subject Keywords */}
                        <div className="space-y-2">
                          <label className="block text-[9px] font-semibold text-gray-500 tracking-[0.1em]">Subject Keywords (OR)</label>
                        ...
                        {/* File Types */}
                        <div className="space-y-2">
                          <label className="block text-[9px] font-semibold text-gray-500 tracking-[0.1em]">File Types</label>
                        ...
                        {/* File Name Patterns */}
                        <div className="space-y-2">
                          <label className="block text-[9px] font-semibold text-gray-500 tracking-[0.1em]">File Name Contains</label>
                        ...
                        {/* Date Range */}
                        <div className="space-y-2">
                          <label className="block text-[9px] font-semibold text-gray-500 tracking-[0.1em]">Date Range</label>
                        ...
                        {/* Folders */}
                        <div className="space-y-2">
                          <label className="block text-[9px] font-semibold text-gray-500 tracking-[0.1em]">Folders (Cloud Drives)</label>
                      ...
                      <div className="pt-4 border-t border-gray-200">
                        <label className="block text-[9px] font-semibold text-gray-500 tracking-[0.1em] mb-3">Exclusion Rules</label>
                      ...
                      <div className="pt-4 border-t border-gray-200">
                        <label className="block text-[9px] font-semibold text-gray-500 tracking-[0.1em] mb-3">Deduplication</label>
                      ...
                      {ingestionResult && (
                        <div className="border border-gray-200 bg-gray-50">
                          <div className="px-4 py-3 border-b border-gray-200">
                            <p className={`text-[9px] font-semibold tracking-[0.15em] ${ingestionResult.success ? 'text-gray-700' : 'text-gray-600'}`}>
                          ...
                          <div className="px-4 py-3">
                            {ingestionResult.totalDocumentsIngested !== undefined ? (
                              <div className="space-y-1.5 text-xs">
                                <div className="flex justify-between">
                                  <span className="text-gray-500 tracking-[0.05em]">Documents Ingested</span>
                                  <span className="text-gray-900 font-medium">{ingestionResult.totalDocumentsIngested}</span>
                                </div>
                                <div className="flex justify-between">
                                  <span className="text-gray-500 tracking-[0.05em]">Items Processed</span>
                                  <span className="text-gray-900 font-medium">{ingestionResult.totalItemsProcessed}</span>
                                </div>
                                {ingestionResult.results && (
                                  <div className="mt-3 pt-3 border-t border-gray-200 space-y-1">
                                    <p className="text-[9px] font-semibold text-gray-500 tracking-[0.1em] mb-2">Breakdown</p>
                            ...
                            {ingestionResult.errors && ingestionResult.errors.length> 0 && (
                              <div className="mt-3 pt-3 border-t border-gray-300">
                                <p className="text-[9px] font-semibold text-gray-600 tracking-[0.1em] mb-2">Errors</p>
            ...
            <div className="bg-white border border-gray-200 rounded-sm">
              <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
                <h2 className="text-xs font-medium text-gray-900 tracking-[0.15em]">Recent Activity</h2>
              </div>
              <div className="p-6">
                <p className="text-xs text-gray-600">
                  {(() => {
