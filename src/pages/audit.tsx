            ...
            <header className="mb-6 pt-2">
              <div className="flex flex-col items-start gap-6 sm:flex-row sm:items-end sm:justify-between">
                <div className="max-w-3xl">
                  ...
                  <h1 className="break-words text-[22px] leading-[1.2] tracking-tight text-[#182026] sm:text-[26px] sm:leading-tight" style={{ fontFamily: "'Montagu Slab', serif", fontWeight: 100 }}>
