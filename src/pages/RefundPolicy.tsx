                ...
                <article className="max-w-3xl mx-auto">
                    ...
                    <div className="space-y-8 text-sm leading-relaxed text-gray-700">
                        ...
                        <section className="space-y-4">
                            ...
                            <p>
                                You may cancel your Opside subscription at any time via your account dashboard or by emailing support@opside.co.
                            </p>
                            <p>
                        ...
                        <section className="space-y-4">
                            ...
                            <p>
                                <strong>Billing Errors:</strong> In the event of a genuine billing error (for example, a charge after cancellation or a double charge), contact support@opside.co within 7 days of the charge. We will investigate promptly and refund any erroneous amount immediately.
                            </p>
                        </section>
