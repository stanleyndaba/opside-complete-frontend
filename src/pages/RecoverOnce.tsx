        ...
        <div className="grid items-start gap-4 lg:grid-cols-[minmax(0,1fr)_380px] lg:gap-10">
          <article className="min-w-0 rounded-[16px] bg-white px-5 py-5 shadow-[0_1px_2px_rgba(25,27,32,0.05)] sm:px-6 sm:py-5" aria-labelledby="recover-once-title">
            <header className="border-b border-[#E8E7E1] pb-7">
              ...
              <p className="mt-1.5 max-w-2xl text-[14px] leading-6 text-[#595E68]">Margin reviewed <strong className="font-semibold text-[#191B20]">3,214 orders, 41 inbound shipments, and 22 returns</strong> from <strong className="font-semibold text-[#191B20]">1 February through 30 April 2026</strong>, comparing shipment, receiving, inventory-adjustment, and available financial records.</p>
              <p className="mt-1.5 max-w-2xl text-[14px] leading-6 text-[#595E68]">That comparison isolated <strong className="font-semibold text-[#191B20]">one inbound-shipment discrepancy</strong> affecting <strong className="font-semibold text-[#191B20]">17 units across two related shipments</strong>. Both shipments trace back to the same supplier delivery, with the activity concentrated in the week of 10 March.</p>
              <p className="mt-1.5 max-w-2xl text-[14px] font-medium leading-6 text-[#191B20]">The issue is not apparent from any one record alone. It becomes visible when the shipment manifest, carrier receiving record, and inventory adjustment history are reconciled together. This is a <strong className="font-semibold">specific, bounded event within the reviewed records—not a general account warning.</strong></p>
            </header>
            ...
            <section className="border-b border-[#E8E7E1] py-5" aria-labelledby="what-margin-found">
              ...
              <p className="mt-1.5 text-[14px] leading-6 text-[#595E68]">The records currently substantiate <strong className="font-semibold text-[#191B20]">14 of the 17 affected units</strong>. The remaining 3 units are held for final verification rather than treated as confirmed.</p>
