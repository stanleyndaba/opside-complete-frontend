        ...
        <div className="grid items-start gap-4 lg:grid-cols-[minmax(0,1fr)_380px] lg:gap-10">
          <article className="min-w-0 rounded-[16px] bg-white px-5 py-5 shadow-[0_1px_2px_rgba(25,27,32,0.05)] sm:px-6 sm:py-5" aria-labelledby="recover-once-title">
            <header className="border-b border-[#E8E7E1] pb-7">
              <div className="mb-3 text-[12px] font-semibold text-[#595E68]">Recover Once</div>
              <h1 id="recover-once-title" className="max-w-2xl font-lora text-[30px] font-normal leading-[1.04] tracking-[-0.025em] text-[#191B20] sm:text-[40px]">Margin found something worth taking over.</h1>
            ...
            <section className="border-b border-[#E8E7E1] py-5" aria-labelledby="what-margin-found">
              ...
              <h2 id="what-margin-found" className="mt-1.5 font-lora text-[23px] font-normal leading-tight tracking-[-0.02em]">What Margin is taking over</h2>
            ...
            <section className="border-b border-[#E8E7E1] py-5" aria-labelledby="why-recover-once">
              ...
              <h2 id="why-recover-once" className="mt-1.5 font-lora text-[23px] font-normal leading-tight tracking-[-0.02em]">Why Recover Once</h2>
            ...
            <section className="border-b border-[#E8E7E1] py-5" aria-labelledby="after-approval">
              ...
              <h2 id="after-approval" className="mt-1.5 font-lora text-[23px] font-normal leading-tight tracking-[-0.02em]">What happens after approval</h2>
            ...
            <section className="border-b border-[#E8E7E1] py-5" aria-labelledby="evidence-and-outcomes">
              ...
              <h2 id="evidence-and-outcomes" className="mt-1.5 font-lora text-[23px] font-normal leading-tight tracking-[-0.02em]">If the evidence or outcome changes</h2>
            ...
            <section className="pt-8" aria-labelledby="completion">
              ...
              <h2 id="completion" className="mt-1.5 font-lora text-[23px] font-normal leading-tight tracking-[-0.02em]">Completion</h2>
          ...
          <aside className="lg:sticky lg:top-20" aria-label="Recover Once decision summary">
            <div className="rounded-[14px] border border-[#D7D7D1] bg-white p-5 shadow-[0_8px_24px_rgba(25,27,32,0.06)] sm:p-4">
              ...
              <h2 className="mt-1.5 font-lora text-[23px] font-normal leading-tight tracking-[-0.02em]">Your decision</h2>
            ...
            <div className="mt-1.5 rounded-[14px] border border-[#E8E7E1] bg-white p-5"><div className="flex items-start gap-3"><ShieldCheck className="mt-0.5 h-5 w-5 shrink-0 text-[#3F51A8]" aria-hidden="true" /><div><p className="text-[12px] font-semibold text-[#191B20]">Seller-controlled operation</p><p className="mt-1 text-[12px] leading-5 text-[#595E68]">Margin prepares and follows through. You review and approve before anything is submitted.</p></div></div></div>
          </aside>
        </div>
      </main>
    </div>
