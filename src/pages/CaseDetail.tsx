              ...
              <div className="flex flex-col gap-0 border border-white/10 divide-y divide-white/10 rounded-2xl overflow-hidden">
                ...
                <div className="p-8 bg-[#0a0a0a]">
                  ...
                  <div className="space-y-6">
                    ...
                    {/* Recovery Info */}
                    <div className="space-y-4">
                      <h4 className="flex items-center gap-2 text-[10px] font-bold text-white/30 border-b border-white/10 pb-2.5 tracking-wider uppercase">
                      ...
                      <div className="space-y-3">
                        {effectiveCase.warehouse_history ? (
                          <div className="p-3 bg-amber-500/5 border border-amber-500/10 rounded-lg">
                            ...
                            <div className="mt-2 text-[9px] text-white/30 font-mono italic">
                    ...
                    <div className="space-y-4">
                      ...
                      {effectiveCase.status === 'Guaranteed' && (
                        <div className="relative pl-6 border-l border-white/10 opacity-40 italic">
                          ...
                          <p className="text-[11px] text-white/30 font-light leading-relaxed mt-4">Verification in progress by {AGENT_NAMES['evidence_matching']}. Case will be filed once ready.</p>
                        </div>
                      )}
                    </div>
                  </div>
                        ...
                        <table className="w-full text-left border-collapse">
                          <thead>
                            <tr className="border-b border-white/5 bg-white/[0.01]">
                              <th className="px-4 py-3 text-[10px] font-bold text-white/40 uppercase tracking-widest font-mono">Timestamp</th>
                              <th className="px-4 py-3 text-[10px] font-bold text-white/40 uppercase tracking-widest font-mono">Event Type</th>
                              <th className="px-4 py-3 text-[10px] font-bold text-white/40 uppercase tracking-widest font-mono">Reference</th>
                              <th className="px-4 py-3 text-[10px] font-bold text-white/40 uppercase tracking-widest font-mono">Confirmation</th>
                            </tr>
                          </thead>
                          <tbody className="divide-y divide-white/5">
                                ...
                                <tr key={event.id || idx} className="hover:bg-white/[0.04] transition-colors group">
                                  ...
                                  <td className="px-4 py-3">
                                    <div className="flex items-center gap-2">
                                      ...
                                      <span className="text-[10px] font-bold text-white/80 font-mono uppercase tracking-tight">
                                  ...
                                  <td className="px-4 py-3">
                                    <Badge variant="outline" className={cn(
                                      "text-[9px] h-4.5 px-2 border-white/10 font-mono uppercase tracking-tighter",
                            ...
                            {(!caseData?.events || caseData.events.filter((e: any) => e.type === 'logistics' || e.type === 'claim' || e.type === 'evidence').length === 0) && (
                              <tr>
                                <td colSpan={4} className="px-4 py-12 text-center text-[10px] font-mono text-white/20">
