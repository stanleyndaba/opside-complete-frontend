      ...
      <main className="relative">
        ...
        <section className="relative border-t border-[#E4EDF1] bg-[#F3F6F8] py-16 md:py-28">
          <div className={containerClass}>
            ...
            >
              <div className="grid grid-cols-[minmax(0,1.2fr)_minmax(180px,1fr)_minmax(180px,1fr)] border-b border-[#D8E3E8] bg-[#F8FAFC] px-5 py-4 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#66737F] md:px-8">
                <div>Capability</div>
