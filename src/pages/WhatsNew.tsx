          ...
          <div className="relative container mx-auto px-8 pt-8 pb-12">
            ...
            <div className="space-y-8">
              {orderedMonths.map((month) => (
                <section key={month}>
                  <h2 className="text-xs font-medium text-gray-900 tracking-[0.15em] mb-4">
                    {month}
                  </h2>
                    ...
                    {groups[month].map((update) => (
                      <div
                        ...
                        <div className="flex items-center justify-between mb-3">
                          <span className="px-2 py-0.5 text-[10px] font-medium bg-gray-100 text-gray-700 border border-gray-200 tracking-[0.05em]">
                            {update.tag}
                          </span>
