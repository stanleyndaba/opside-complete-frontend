...
const Docs = () => {
  usePageMeta({
    title: 'Opside Acceptable Use Policy',
    description: "Acceptable use standards for Opside's automated reimbursement platform.",
      ...
      <main className="flex-1 container mx-auto px-6 py-12 md:py-16">
        <article className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-sm leading-relaxed text-gray-700">
            <p>
              This Acceptable Use Policy ("AUP") is incorporated into and forms a binding part of the Opside Terms of Service ("TOS"). It defines the only permitted use of Opside and establishes zero-tolerance enforcement for any behavior that could harm Amazon, its systems, or the integrity of the Seller Central ecosystem.
            </p>
            <p>
            ...
            <section className="space-y-4">
              ...
              <p>Opside may be used exclusively for:</p>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Using Opside for third-party accounts, agency services, or account management on behalf of others</li>
                <li>Reselling, redistributing, or repurposing Opside data or functionality</li>
            ...
            <section className="space-y-4">
              ...
              <p>You are strictly prohibited from using Opside to:</p>
              ...
              <div className="overflow-x-auto mt-4">
                <table className="w-full text-sm border border-gray-200">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    ...
                    <tr>
                      <td className="py-3 px-4">Interfere with, reverse engineer, or exploit Opside, SP-API, or Amazon systems</td>
                    ...
                    <tr>
                      <td className="py-3 px-4">Use any PII obtained via Opside for marketing, solicitation, profiling, or any non-reimbursement purpose</td>
                      <td className="py-3 px-4">Immediate termination</td>
                    </tr>
                    <tr>
              ...
              <p className="pl-4 border-l-2 border-gray-300 text-gray-700 mt-4">
                The User assumes 100% liability for the accuracy, legitimacy, and compliance of every claim submitted through Opside.
              </p>
            </section>

            <section className="space-y-4">
              <h2 className="text-base font-medium text-gray-900">3. Monitoring and Enforcement</h2>
              <p>Opside actively protects the Amazon ecosystem.</p>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <p>Upon detection of an AUP violation, Opside will:</p>
            ...
            <section className="space-y-4">
              ...
              <p className="pl-4 border-l-2 border-gray-300 text-gray-700">
                You agree to indemnify, defend, and hold harmless Opside, its officers, directors, employees, and agents from and against any and all claims, damages, losses, liabilities, costs, and expenses (including reasonable attorneys' fees) arising from:
              </p>
              <ul className="list-disc pl-6 space-y-1 mt-2">
                <li>Your breach of this AUP</li>
                <li>Your submission of fraudulent or non-compliant claims</li>
                <li>Any investigation, penalty, or action by Amazon resulting from your use of Opside</li>
              </ul>
