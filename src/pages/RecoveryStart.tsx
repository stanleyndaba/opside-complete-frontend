  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#FBFAF7] font-sans text-[#191B20]">
      ...
      <main className="mx-auto max-w-[1280px] px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <section className="mx-auto max-w-3xl rounded-[14px] border border-[#E8E7E1] bg-white p-5 shadow-[0_1px_2px_rgba(25,27,32,0.05)] sm:p-8" aria-labelledby="recovery-start-title">
          <div className="max-w-2xl border-b border-[#E8E7E1] pb-5">
            <div className="mb-3 flex items-center gap-2 text-[12px] font-semibold text-[#595E68]">
              ...
              <span>Start with Margin</span>
            </div>
            <h1 id="recovery-start-title" className="font-lora text-[30px] font-normal leading-[1.08] tracking-[-0.02em] text-[#191B20] sm:text-[38px]">How would you like to begin?</h1>
            <p className="mt-3 max-w-xl text-[15px] leading-6 text-[#595E68]">Choose the way you want Margin to start understanding your recovery work.</p>
          </div>
          ...
          <div className="mt-5 rounded-[10px] border border-[#D7D7D1] bg-[#F4F3ED] p-4 sm:p-5">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              <Link to="/audit" className={optionClass}>
                <span><span className="block">Audit Account</span><span className="mt-1 block text-[12px] font-normal text-[#777A82]">Connect your account for a guided review.</span></span>
