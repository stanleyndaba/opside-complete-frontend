...
export function Sidebar({
  ...
  return <aside className={cn("bg-white fixed left-0 top-0 transition-all duration-300 ease-in-out flex flex-col border-r border-gray-200 h-screen z-40", isCollapsed ? "w-16" : "w-56", className)}>
      ...
      {/* Profile Section */}
      {!isCollapsed ? <div className="p-4 border-b border-gray-200">
          <DropdownMenu>
            ...
            <DropdownMenuContent side="right" align="start" className="w-64 bg-white border border-gray-200 shadow-lg">
              {/* Section 1: Identity */}
