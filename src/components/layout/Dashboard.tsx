...
export function Dashboard() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col h-screen overflow-hidden platform">
      ...
      <div className="flex-1 flex h-full overflow-hidden">
        ...
        <main className={'flex-1 transition-all duration-300 overflow-y-auto ' + mainClass}>
          <div className="relative">
            <div className="relative w-full bg-[#0B1220] min-h-[calc(100vh+96px)] -mt-16 pt-16">
