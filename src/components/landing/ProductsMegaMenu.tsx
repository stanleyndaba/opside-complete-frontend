...
export function ProductsMegaMenu({ variant = 'dark' }: ProductsMegaMenuProps) {
    ...
    const panelClassName = 'lg:fixed lg:left-1/2 lg:-translate-x-1/2 lg:top-[85px] flex flex-col lg:flex-row w-[calc(100vw-2rem)] lg:w-[95vw] lg:max-w-[1440px] bg-[#07101A] rounded-[22px] overflow-hidden shadow-[0_28px_90px_rgba(0,0,0,0.62)] ring-1 ring-white/8';
    const labelClassName = 'text-[9px] font-bold text-white/35 uppercase tracking-tight';
                ...
                <NavigationMenuItem>
                    ...
                    <NavigationMenuContent>
                        <div className={cn(panelClassName, 'relative z-[100]')}>
                            ...
                            <div className="flex-[1.6] border-r border-white/5 p-6 lg:p-7">
                            ...
                            <div className="flex-1 border-r border-white/5 bg-white/[0.01] p-6 lg:p-7">
                            ...
                            <div className="flex-[0.8] bg-white/[0.02] p-6 lg:p-7">
                                <h4 className={cn(labelClassName, 'mb-5')}>
                                    By Seller Type
                                </h4>
                                ...
                                <div className={cn(
                                    ...
                                    <h5 className="mb-1 text-[9px] font-bold text-white">Enterprise Support</h5>
                                    <p className="mb-3 line-clamp-1 text-[8px] leading-relaxed text-white/40">
                                        Recovery coverage for larger and more complex operations.
                                    </p>
                                    <div className="flex cursor-default items-center gap-1.5 text-[8px] font-bold uppercase tracking-tight text-white/70">
