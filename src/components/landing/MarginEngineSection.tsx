  ...
  return (
    <section className="relative hidden overflow-hidden bg-[#F4FAFC] py-[52px] md:block md:py-[76px]" aria-labelledby="margin-engine-title">
      ...
      <div className="relative mx-auto w-full max-w-[1240px] px-5 sm:px-8">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.6 }} className="mx-auto w-full max-w-[1040px]">
