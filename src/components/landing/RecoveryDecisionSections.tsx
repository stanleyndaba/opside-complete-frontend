  ...
  <section className="relative border-b border-[var(--margin-border)] bg-[var(--margin-canvas)] py-16 sm:py-20 md:py-28">
    <div className="mx-auto w-full max-w-[1280px] px-5 sm:px-6 md:px-8 lg:px-10 2xl:px-12">
      <div className="grid gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-center lg:gap-16">
        ...
        <motion.div {...revealProps} transition={{ ...revealProps.transition, delay: 0.12 }} className="relative isolate min-h-[280px] overflow-hidden rounded-[10px] border border-white/10 bg-[#050608] px-3 py-5 shadow-[0_28px_90px_rgba(0,0,0,0.22)] sm:min-h-[360px] sm:px-6 sm:py-8 lg:min-h-[430px] lg:px-8 lg:py-10">
