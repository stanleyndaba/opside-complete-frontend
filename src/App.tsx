...
const RecoverOnce = lazy(() => import("./pages/RecoverOnce"));`r`nconst RecoveryWorkspace = lazy(() => import("./pages/RecoveryWorkspace"));
                  ...
                  <SmoothScrollProvider>
                    <RoutePreloader />
                      ...
                      <Suspense fallback={<RouteSkeleton />}>
                        ...
                        <Route path="/recover-once" element={<RecoverOnce />} />`r`n                        <Route path="/recovery-workspace" element={<RecoveryWorkspace />} />
